...
areNumeric <- sapply(meateggsnuts, is.numeric)
meateggsnuts[areNumeric] <- lapply(meateggsnuts[areNumeric], round, digits=2)
```
...
# rounding for display
areNumeric <- sapply(dairy, is.numeric)
dairy[areNumeric] <- lapply(dairy[areNumeric], round, digits=2)
```
...
# rounding for display
areNumeric <- sapply(fruits, is.numeric)
fruits[areNumeric] <- lapply(fruits[areNumeric], round, digits=2)
```
...
# rounding for display
areNumeric <- sapply(vegetables, is.numeric)
vegetables[areNumeric] <- lapply(vegetables[areNumeric], round, digits=2)
```
...
# rounding for display
areNumeric <- sapply(grains, is.numeric)
grains[areNumeric] <- lapply(grains[areNumeric], round, digits=2)
```
...
# rounding for display
areNumeric <- sapply(fats, is.numeric)
fats[areNumeric] <- lapply(fats[areNumeric], round, digits=2)
```
...
# rounding for display
areNumeric <- sapply(sugars, is.numeric)
sugars[areNumeric] <- lapply(sugars[areNumeric], round, digits=2)
```
