...
write.csv(combined_incidence, file='resources/processed_data/combined_incidence.csv')
write.csv(mortality, file='resources/processed_data/mortality.csv')
write.csv(combined_mortality, file='resources/processed_data/combined_mortality.csv')
