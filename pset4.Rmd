...
> Myles Ingram (`mai2125`) and Colin Payne-Rogers (`cmp2250`)
...
> Myles will focus on data collecting and transformation. Colin will focus on managing the GitHub repository setup. With only two of us, we think we can manage collaborating more closely on plot creation and chapter writing.
...
> With just two of us, we plan to merge each other's pull requests. The team member who writes a given contribution is responsible for resolving merge conflicts. The other team member will serve as reviewer, approve pull requests, and merge them.
...
> [https://github.com/cpaynerogers/edav-final]
...
> [https://github.com/cpaynerogers/edav-final/graphs/contributors]
